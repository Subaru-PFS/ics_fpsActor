...
just run; with it applied, a cobra the map mispredicts by a fifth is still pushed the
distance intended.  `usableGain` falls back to `DEFAULT_GAIN` where the measurement is
missing or outside `GAIN_BOUNDS`.
"""
