...
class FpsCmd(object):
    ...
    def moveToPfsDesign(self, cmd):
        ...
        # calculating notConvergedDistanceThreshold
        try:
            notConvergedToleranceFactor = self.actor.actorConfig['pfsConfig']['notConvergedToleranceFactor']
            notConvergedDistanceThreshold = notConvergedToleranceFactor * tolerance
        except KeyError:
